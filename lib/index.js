                ...
                res.ue_list = function () {
                    ...
                    for (var i = 0; i < 30; i++) {
                        funcs.push(new Promise((resolve, reject) => {
                            qn_client.list(`/${config.qn.prefix}/${moment().add(-i, 'days').format('YYYYMMDD')}/`, function (err, result) {// /ue/20170908/
            ...
            busboy.on('file', function (fieldname, file, filename, encoding, mimetype) {
                ...
                res.ue_up = function (img_url) {
                    ...
                    if (config.qn) {
                        ...
                        client.upload(file, {
                            key: `${config.qn.prefix}/${moment().format('YYYYMMDD')}/${name}`			//例如： ue/20170908/dafhfjaadfkjsdhjdf.jpg
